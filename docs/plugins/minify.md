...
![ProperDocs normal page source code snippet](mkdocs-view-source.png)
...
![ProperDocs minified page source code snippet](mkdocs-view-source-minified.png)
